...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            // Insert new user
            $insert_query = "INSERT INTO users (username, email, password, phone) VALUES ('$username', '$email', '$hashed_password', '$phone')";
    ...
    <div class="container">
        <div class="signup-container">
            ...
            <div class="login-link">
                Already have an account? <a href="login.php<?php echo isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : ''; ?>">Login</a>
            </div>
        </div>
    </div>
